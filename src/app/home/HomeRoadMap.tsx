  ...
  return (
    <div className={cn("flex flex-col gap-6", className)}>
      ...
      <div className="relative">
        <div className="bg-orange-400 md:w-full mt-6 md:mt-0 w-2 h-full absolute left-0 -top-3 md:h-2" />
        <div className="grid grid-cols-auto-fill-full gap-4 md:grid-cols-4">
          {homeChangelogs.map((road) => (
            <div
              ...
              key={road.id}
            >
              <div className="h-4 w-4 rounded-xl border -ml-7  md:-ml-1 border-orange-200 mt-2 md:-mt-10 bg-white absolute" />
              <Link
                href={road.href}
