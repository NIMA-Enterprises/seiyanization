...
<HomePage >
 <div className="max-w-screen flex flex-col justify-center gap-4 mt-6 w-full h-full">
    ...
    <Tabs className="flex flex-col md:flex-row gap-6 items-start h-[300px]" defaultValue="example1">

<div className='flex-1'>
    <TabsList className="flex mt-2 h-[350px] flex-col items-start justify-center rounded-xl p-4 gap-2 lg:p-4 lg:gap-6 text-inherit bg-sei-card-bg-light border   dark:bg-sei-card-bg-dark  dark:border-sei-border-dark">
      <TabsTrigger
        className="lg:pb-5 border-b w-full border-sei-border-light dark:border-sei-border-dark text-md font-semibold justify-start !rounded-none !bg-transparent !shadow-none text-link-hover data-[state=active]:text-link-no-underline"
        value="example1"
      >
