 ...
 <div className="max-w-screen flex flex-col justify-center gap-4 mt-6 w-full h-full">
    ...
    <TabsList className="w-full  flex mt-2 h-[350px] flex-col items-start justify-center rounded gap-4 lg:p-4 lg:gap-6 pt-0 text-inherit bg-sei-card-bg-light dark:bg-sei-card-bg-dark  ">
      <TabsTrigger
        ...
        value="example1"
      >
        <div className="flex text-xl w-full items-center border border-sei-border-light dark:border-sei-border-dark hover:border-transparent hover:bg-sei-card-inner-light hover:dark:bg-sei-card-inner-dark flex-wrap gap-1 p-6 bg-sei-card-light dark:bg-sei-card-dark rounded">
